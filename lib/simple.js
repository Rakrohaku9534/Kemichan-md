...
/*exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Kikuchanj', body: '2023 © Fahrul', sourceUrl: 'https://wa.me/6285786539008', thumbnail: data }}, options })
    }
    m.name = m.pushName || conn.getName(m.sender)
